  ...
  return (
    <main id="main" className="reserve-home reserve-story">
      ...
      <section id="the-people" className="reserve-story-section people-story" data-scene aria-labelledby="people-title">
        ...
        <div className="people-intro" data-reveal><h2 id="people-title">The craft.<br /><em>The bigger picture.</em></h2><p>Two independent businesses give this first shared location its character. Katie owns her salon craft. Neil carries grooming, products, performance, and wellness beyond the visit.</p></div>
        <div className="people-cards">
          ...
          <Link href="/gent-ascend" className="people-card people-neil" data-reveal><div className="people-image" aria-hidden="true" /><div className="people-copy"><span className="eyebrow">NEIL · GENT ASCEND COLLECTIVE</span><h3>Carry the care<br /><em>into your life.</em></h3><p>Neil’s independent company builds the products, grooming direction, daily practices, performance, and wellness experience beyond this location.</p><span className="people-link">Meet GENT Ascend <ArrowUpRight size={19} /></span><small>CONCEPT IMAGERY</small></div></Link>
        </div>
      </section>
      <section className="reserve-union" data-scene aria-labelledby="union-title"><div className="union-architecture" aria-hidden="true"><span /><span /><span /></div><div className="union-content" data-reveal><p className="eyebrow">FIX IT SHOP × GENT ASCEND COLLECTIVE</p><h2 id="union-title">Separate strengths.<br /><em>One Reserve.</em></h2><p>The Reserve is their first shared physical home in Eunice. Katie’s salon and Neil’s wider men’s experience each keep their own identity, craft, and relationship with you.</p><span>THE RESERVE AT SANCTUM · EUNICE, LOUISIANA</span></div></section>
      <Worlds />
      <section id="beyond" className="reserve-story-section visit-story" data-scene aria-labelledby="visit-title"><div className="story-meta"><span>05 / BEYOND THE VISIT</span><span>CARE THAT CARRIES FORWARD</span></div><div className="visit-layout"><div data-reveal><p className="eyebrow">THE RESERVE IS TAKING SHAPE</p><h2 id="visit-title">The visit ends.<br /><em>The care carries on.</em></h2><p>Keep your visits and Chair preferences here at the Reserve. For the wider grooming, product, performance, and wellness journey, step into Neil’s Gent Ascend Collective.</p><div className="story-actions"><Link href="/chair" className="button button-gold">Explore Katie’s Chair <ArrowUpRight size={17} /></Link><Link href="/gent-ascend" className="text-link">Meet Gent Ascend <ArrowUpRight size={17} /></Link></div></div><div className="visit-panel" data-reveal><span>YOUR RESERVE ACCOUNT</span><h3>Your visit.<br />Your preferences.</h3><ul><li>Appointments with Katie</li><li>Chair preferences, shared only as you choose</li><li>Optional consultation intake with Neil</li></ul><Link href="/my-sanctum">Open your Reserve account <ArrowUpRight size={17} /></Link></div></div></section>
      ...
      <section id="begin" className="reserve-story-section begin-story" data-scene aria-labelledby="begin-title"><div className="story-meta"><span>07 / YOUR FIRST STEP</span><span>THERE IS NO ONE WAY TO BEGIN</span></div><h2 id="begin-title" data-reveal>Where do<br /><em>you begin?</em></h2><div className="begin-grid"><Link href="/fix-it-shop" className="begin-card" data-reveal><span>01</span><h3>Enter the Shop</h3><p>Meet Katie, explore the care behind the cut, and prepare for a visit.</p><strong>Meet Fix It Shop <ArrowUpRight size={18} /></strong></Link><Link href="/gent-ascend" className="begin-card" data-reveal><span>02</span><h3>Carry it Further</h3><p>Explore Neil’s independent Gent Ascend world beyond the Reserve.</p><strong>Explore GENT Ascend <ArrowUpRight size={18} /></strong></Link><Link href="/visit" className="begin-card" data-reveal><span>03</span><h3>Find the Reserve</h3><p>Discover the first shared physical home in Eunice.</p><strong>Discover the place <ArrowUpRight size={18} /></strong></Link></div></section>
    </main>
  );
}
