    ...
    <main id="main" className="reserve-home reserve-story">
      ...
      <section id="the-place" className="reserve-story-section reserve-premise" data-scene aria-labelledby="premise-title">
        ...
        <div className="premise-scenes">
          <figure className="story-scene story-scene-chair" data-reveal><div className="story-scene-art" role="img" aria-label="Concept scene of a stylist cutting a man's hair" /><figcaption>THE CRAFT · CONCEPT IMAGERY</figcaption></figure>
          ...
          <figure className="story-scene story-scene-ritual" data-reveal><div className="story-scene-art" role="img" aria-label="Concept scene of grooming products and a notebook on a wooden table" /><figcaption>THE RITUAL · CONCEPT IMAGERY</figcaption></figure>
        </div>
      ...
      <section className="community-story" data-scene aria-labelledby="community-title"><div className="community-scene" role="img" aria-label="Concept scene of three men in conversation on a small-town street" /><div className="community-copy" data-reveal><p className="eyebrow">ROOTED HERE · OPEN TO WHAT COMES NEXT</p><h2 id="community-title">You’ve got<br /><em>things to build.</em></h2><p>Men need places to show up, take care of themselves, and be part of something. The Reserve begins with grooming and a shared space. Community and wellness are part of the vision we are building toward.</p><span>CONCEPT IMAGERY · NOT A PHOTOGRAPH OF THE RESERVE</span></div></section>
